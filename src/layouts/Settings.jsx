    ...
    <section className="min-h-screen">
      <Container className="bg-[#000E08] w-full flex flex-col h-full">
        <div className="my-[52px] flex-shrink-0 ">
          <div className="relative flex items-center justify-between px-5 pt-[61px]">
            ...
            <h1 className="text-center font-robot text-[20px] font-medium text-white">
              Settings
            </h1>

            <IoIosLogOut onClick={handellogout} className="text-white  duration-300  hover:text-amber-700 text-4xl  cursor-pointer" />
          ...
          <div className="flex justify-between items-center px-5 pt-[50px]">
            <div className="flex gap-4">
              ...
              <div>
                ...
                <p className="font-normal text-base font-robot text-navtext">
                  Never give up 💪
                </p>
              </div>
            </div>
